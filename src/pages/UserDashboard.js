...
function UserDashboard() {
  ...
  const fetchResumeData = async () => {
    try {
      const res = await axios.get(`https://server-res-five.vercel.app/api/user-resume?email=${user.email}`);
  ...
  const handleUpdatePassword = async () => {
    ...
    try {
      const res = await axios.post('https://server-res-five.vercel.app/api/forgot-password', { email: user.email, newPassword });
      if (res.data.success) {
  ...
  const handleResumeUpload = async (e) => {
    ...
    try {
      const res = await axios.post('https://server-res-five.vercel.app/api/upload-resume', formData, {
  ...
  const handleDeleteResume = async () => {
    try {
      const res = await axios.delete('https://server-res-five.vercel.app/api/delete-resume', {
